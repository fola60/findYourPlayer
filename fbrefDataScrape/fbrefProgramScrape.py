...
with open('playerData.csv', 'w', newline='', encoding = 'utf8') as f:
    theWriter = writer(f)
    header = ['player', 'Nation', 'pos', 'team', 'comp', 'age', 'BirthYear', '_90s', 'gls', 'sh', 'sot', 'sotpct', 'sotper90', 'g_sh', 'g_sot', 'av_dis', 'Shots-from-free-kicks', 'Penalties-created', 'Penalties-attempted', 'xg', 'npxg', 'npxg_sh', 'gmin_xg', 'npG-npxG','cmp','pass-attempted','cmppct','total-pass-distance','progPass-distance','short-pass-completed','short-pass-attempted','sho_cmppct','medium-pass-completed','medium-pass-attempted','med_cpmpct','long-pass-completed','long-pass-attempted','lon_cmppct','ast','xag','xa','a-xAg','kp','fin3rd_p','p_inpen','crs_inpen','prog_p','tkl','tkl_w','tackleDef3rd','tackleMid3rd','tkl_att3rd','drb_tkl','drb_chl','drb_tklpct','chl_lst','blck','sh_blck','p_blck','intc','clr','sca','sca_p90','sca_pl','sca_pd','sca_to','sca_sh','sca_fd','sca_def','gca','gca_90','gca_to','tch','tch_defpen','tch_def','tch_mid','tch_att','tch_attpen','to_att','to_suc','to_supct','to_tklpct','crrs','crrs_dis','crss_prgdis','prg_crss','crrs_fin3rd','crrs_pen','mis','dis','p_rec','prg_prec']#Definng header
